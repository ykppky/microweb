...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
                ...
                $('.selected').remove();
                parent.children('li').children('a').children('.arrow').removeClass("ion-ios-arrow-down").addClass("ion-ios-arrow-left");
                parent.children('li.open').children('a').children('.arrow').removeClass('open');
                parent.children('li.open').children('.sub-menu').slideUp(200);
                parent.children('li.open').removeClass('open');
                parent.children('li.open').children('.sub-menu').children().removeClass('open');
                ...
                if (sub.is(":visible")) {
                    ...
                    jQuery('.arrow', jQuery(this)).removeClass("ion-ios-arrow-down").addClass("ion-ios-arrow-left");
                    ...
                    jQuery('.arrow', jQuery(this)).removeClass("ion-ios-arrow-left").addClass("ion-ios-arrow-down");
