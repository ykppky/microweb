...
<ul class="mainmenu">
    <?php for($i = 0; $i<count($activities);$i++ )
            { 
        ?>
    <li><a href="index.php/welcome/getactivitycontent/?id=<?php echo $activities[$i]['id'] ?>"><em></em>
    <p>
        <span><?php echo $activities[$i]['title'] ?></span>
    </p>
    <b></b></a></li>
    <?php 
            }
...
?>
    ...
    <div style="height: 34px;width: 100px; border:1px solid #666 ;float:right; margin: 15px 16px; line-height: 34px;text-align: center;">
        <a href="index.php/welcome/activitieslist/catalog/<?php echo ($curpage+1) ?>">下一页</a>
    </div>
    ...
    <div style="height: 34px;width: 100px; border:1px solid #666 ;float:right; margin: 15px 16px; line-height: 34px;text-align: center;">
        ...
        <?php
         ...
         ?>
    <div style="height: 34px;width: 100px; border:1px solid #666 ;float:left; margin: 15px 14px;line-height: 34px; text-align: center;"><a href="index.php/welcome/activitieslist/catalog/<?php echo ($curpage-1) ?>">上一页</a></div>
    <div style="height: 34px;width: 100px; border:1px solid #666 ;float:right; margin: 15px 16px; line-height: 34px;text-align: center;"><a href="index.php/welcome/activitieslist/catalog/<?php echo ($curpage+1) ?>">下一页</a></div>
    <?php 
