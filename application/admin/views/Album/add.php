                ...
                <div class="span12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="admin.php/<?php echo $url['list']?>" class="btn blue"><i class="ion-ios-refresh-outline"></i> 返回</a>
                                <a href="admin.php/<?php echo $url['add']?>" class="btn blue"><i class="ion-arrow-return-left"></i> 重置</a>
                            </div>
