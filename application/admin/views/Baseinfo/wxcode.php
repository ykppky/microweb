    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    <h3 class="page-title"> 关注我们 <small></small></h3>

                    <ul class="breadcrumb">
                        <li><i class="ion-ios-home"></i> <a href="admin.php">后台管理</a> <i
                                class="ion-ios-arrow-forward"></i></li>
                        <li><a >学校信息</a> <i class="ion-ios-arrow-forward"></i></li>
                        <li><a >关注我们设置</a></li>
                    </ul>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="ion-ios-list-outline"></i>关注我们</div>

                        </div>
                        <div class="portlet-body">
                            <div class="tab-content">
                                <!-- BEGIN FORM-->
                                <form action="<?php echo base_url();?>admin/index.php/baseinfo/updateWxCode" method="post" name="form1" id="form1" class="form-horizontal" onSubmit="return checkform();">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls"  style=" margin-top: -14px;">
                                            ...
                                            <img src="uadmin/user/<?php echo $folder?>/common/<?php echo $wxcode?>" id="pic" onerror="imgLoadError(this);">
                                            <p></p>
...
<script>
    KindEditor.ready(function(K) {
        ...
        var uploadbutton = K.uploadbutton({
            ...
            fieldName : 'imgFile',
            url : 'kindeditor/php/upload_json_rar.php?dir1=<?php echo $folder?>&dir=common&fold_name=',
