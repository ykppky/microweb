						...
						<div class="portlet box green">
							...
							<div class="portlet-body">
								<div class="tab-content">
									<!-- BEGIN FORM-->
									<form action="<?php echo base_url();?>admin.php/Systemsetting/manual_update_deal" method="post" name="form1" id="form1" class="form-horizontal">
