                ...
                <div class="span12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="ion-ios-list-outline"></i>微信好友转发设置</div>
                        ...
                        <div class="portlet-body">
                            <div class="tab-content">
                                ...
                                <form action="<?php echo base_url();?>admin.php/SystemSetting/dealWeixin" method="post" name="form1" id="form1" class="form-horizontal" onSubmit="return checkform();">
                                    <input name="deal_type" type="hidden" value="friend">
                                    <div class="control-group">
                                        <label class="control-label">转发标题:</label>
                                        <div class="controls">
                                            <input type="text"   name="title"  value="<?php echo $value['title']?>"  class="m-wrap medium"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">转发语:</label>
                                        <div class="controls">
                                            <input type="text"   name="friend"  value="<?php echo $value['forward_friend']?>"  class="m-wrap medium"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls"  style=" margin-top: -14px;">
                                            ...
                                            <img src="uadmin/user/<?php echo $folder?>/ads/<?php echo $value['friend_icon']?>" id="pic" onerror="imgLoadError(this);">
                                            <p></p>
                                            <input name="picname" type="hidden" id="picname" value="<?php echo $value['friend_icon']?>">
