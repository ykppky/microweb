                ...
                <div class="span12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="admin.php/SystemSetting/advertupdate" class="btn blue"><i class="ion-ios-arrow-back"></i> 返回</a>
                            </div>
                        </div>
                                ...
                                <form action="<?php echo base_url();?>admin.php/systemsetting/deal" method="post" name="form1" id="form1" class="form-horizontal" onSubmit="return checkform();">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls" style=" margin-top: -10px;">
                                            <!--  
                                            <p>
                                            <div class="alert" style="display:inline-block;*display:inline;*zoom:1;">
                                            <strong>提示!</strong> 请上传1000px * 286px尺寸的图片.
                                            </div>
                                            </p>
                                            -->
                                            <img src="uadmin/user/ads/<?php echo $value['img']?>" id="pic" onerror="imgLoadError(this);">
                                            <p></p>
